package fast.campus.netplix3.entity.token;


import fast.campus.netplix3.aduit.MutableBaseEntity;
import fast.campus.netplix3.token.NetplixToken;
...
public class TokenEntity extends MutableBaseEntity {
    ...
    public static TokenEntity newTokenEntity(String userId, String accessToken, String refreshToken) {
        ...
        return new TokenEntity(userId, accessToken, refreshToken, getAccessTokenExpiredAt(now), getRefreshTokenExpiredAt(now));
    }
